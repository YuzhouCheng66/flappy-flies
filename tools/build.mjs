...
for(const name of ['index.html','game.css','game.mjs','contracts.js','race.js','race-clock.mjs','client.mjs','inference-worker.mjs','gpu-model.mjs','gpu-device.mjs','engine.mjs','graph-loader.mjs','README.md','THIRD_PARTY_NOTICES.md','validation.json'])await fs.copyFile(path.join(root,name),path.join(out,name));
